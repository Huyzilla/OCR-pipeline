# **VIETTEL AI RACE** TD056 **TỔNG QUAN DANH SÁCH LIÊN KẾT**

**ĐƠN** <sup>L</sup>ần ban hành: 1
...
## **VIETTEL AI RACE** TD056 **TỔNG QUAN DANH SÁCH LIÊN KẾT ĐƠN** <sup>L</sup>ần ban hành: 1

<Kiểu N> <Thành viên N>; }; Khi đó, danh sách liên kết đơn được định nghĩa như sau: struct node { Item infor; //*Thành phần thông tin của node;* struct node \*next; //*thành phần con trỏ của node* } \*Start; //*Start là một danh sách liên kết đơn*
...
# **TỔNG QUAN DANH SÁCH LIÊN KẾT ĐƠN** <sup>L</sup>ần ban hành: 1
