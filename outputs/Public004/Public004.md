...
**TỔNG QUAN VỀ CÔNG NGHỆ IN BÊ TÔNG 3D** <sup>L</sup>ần ban hành: 1
...
*1.3.1.4. \* Công nghệ in bê tông 3D quy mô lớn sử dụng bê tông cường độ cao (Large-Scale 3DCP using Ultra-High Performance Concrete)*
...
#### **VIETTEL AI RACE** TD004 **TỔNG QUAN VỀ CÔNG NGHỆ IN BÊ TÔNG 3D** <sup>L</sup>ần ban hành: 1
