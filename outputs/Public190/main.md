...
- 9. Cú pháp cho các đối tượng schema và các phần trong câu lệnh SQL: Quy định cách sử dụng cú pháp để tham chiếu và thao tác trên

các đối tượng trong cơ sở dữ liệu, đồng thời phân biệt rõ ràng giữa các phần của câu lệnh SQL.
...
SELECT department, COUNT(\*) AS num\_employees, AVG(salary) AS avg\_salary
