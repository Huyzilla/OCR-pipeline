...
trình dưới đây. Trong đó, thuật toán sinh xâu nhị phân kế tiếp từ một xâu nhị phân bất kỳ là hàm *Next\_Bits\_String*().
...
Trong đó, thuật toán sinh tổ hợp kế tiếp có tên là Next\_Combination().
...
### **VIETTEL AI RACE** TD051 **THUẬT TOÁN SINH - THUẬT TOÁN ĐỆ QUY** Lần ban hành: 1

while(OK){ //*lặp trong khi cấu hình chưa phải cuối cùng* Result(); //*đưa ra cấu hình hiện tại* Next\_Combination(); //*sinh ra cấu hình kế tiếp* }
...
### **THUẬT TOÁN SINH - THUẬT TOÁN ĐỆ QUY** Lần ban hành: 1
...
thông qua bài toán *P*' giống như *P* được gọi là thuật toán đệ qui giải bài toán *P*. Một hàm được gọi là đệ qui nếu nó được gọi trực tiếp hoặc gián tiếp đến chính nó.
