...
**Định nghĩa thuật toán (Algorithm)**: Thuật toán *F* giải bài toán *P* là dãy các thao tác sơ cấp *F*1, *F*2,..,*F*<sup>N</sup> trên tập dữ kiện đầu vào (*Input*) để đưa ra được kết quả ra (*Output*).

$$F_1F_2..F_N(Input) \cdot Ouput.$$

• *F* = *F*1*F*2..*F*<sup>N</sup> được gọi là thuật toán giải bài toán *P*. Trong đó, mỗi *F*<sup>i</sup> là các phép toán sơ cấp.
