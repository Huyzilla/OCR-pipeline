...
Với dòng thứ i trong bảng dữ liệu, gọi  $x_1$  là lương và  $x_2$  là thời gian làm việc của hồ sơ thứ i.
 ...
 $p(x^{(i)} = 1) = \hat{v}_i$  là xác suất mà model dư đoán hồ sơ thứ i được cho vay.
...
Giờ cũng cần một hàm để đánh giá độ tốt của model. Như bài trước là v càng gần y càng tốt, giờ cũng vây:

- Nếu hồ sơ thứ i là cho vay, tức  $y_i = 1$  thì ta cũng mong muốn  $y_i$  càng gần 1 càng tốt hay model dư đoán xác suất người thứ i được vay vốn càng cao càng tốt.
...
Với mỗi điểm  $(x^{(i)}, y_i)$ , gọi hàm loss function  $L = -(y_i \log \log \hat{y}_i + (1 - y_i))$  $\log \log (1 - \hat{y}_i)$ ), loss function này có tên goi là binary crossentropy

Mặc định trong machine learning nói chung hay deep learning thì viết log hiểu là 2025-09-23 22.39.50\_A
