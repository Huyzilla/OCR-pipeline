|  | VIETTEL AI RACE       | TD031           |
|--|-----------------------|-----------------|
|  | LINH KIỆN THỤ<br>ĐỘNG | Lần ban hành: 1 |
...
- Tổng điện trở bình thường: RT=60 ΩR\_T = 60\,\Omega (240 ÷ 4 = 60 Ω)
- Khi dòng điện giảm còn 3 A, điện trở tăng: RT=240÷3=80 ΩR\_T = 240 ÷ 3 = 80\,\Omega → báo hiệu mạch có vấn đề.
...
o Dây dẫn tốt: đồng, bạc, nhôm

o Cách điện: cao su, thủy tinh, sứ

# **VIETTEL AI RACE** TD031

**LINH KIỆN THỤ ĐỘNG** Lần ban hành: 1

# **Chiều dài (L)**

- o Dây càng dài, điện trở càng cao.
- o Ví dụ: dây 2 m → điện trở gấp đôi dây 1 m

# **Diện tích mặt cắt ngang (A)**

- o Mặt cắt lớn → điện trở giảm.
- o Ví dụ: diện tích tăng gấp đôi → điện trở giảm phân nửa
...
$$RT = R1 + R2 + R3 + ... R_T = R_1 + R_2 + R_3 + \cdot dots$$

**Ví dụ 1:** 3 điện trở nối tiếp

- R1=2 Ω,R2=4 Ω,R3=6 ΩR\_1 = 2\,\Omega, R\_2 = 4\,\Omega, R\_3 = 6\,\Omega
- Dòng điện I=4 AI = 4\,A
- Tổng điện trở: RT=2+4+6=12 ΩR\_T = 2 + 4 + 6 = 12\,\Omega
- Điện áp nguồn: E=I⋅RT=4×12=48 VE = I \cdot R\_T = 4 \times 12 = 48\,V
...
- R1=3 kΩ,R2=10 kΩ,R3=5 kΩR\_1 = 3\,k\Omega, R\_2 = 10\,k\Omega, R\_3 = 5\,k\Omega
- Dòng điện trong mạch:

Sau đó, điện áp rơi trên mỗi điện trở:

$$VR1 = I \cdot R1 = 0.5 \times 3 = 1.5 \ VV_{R1} = I \ R_1 = 0.5 \ x3 = 1.5 \ VV_{R2} = I \cdot R2 = 0.5 \times 10 = 5 \ VV_{R2} = I \cdot R_2 = 0.5 \times 10 = 5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = 1.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3} = I \cdot R_3 = 0.5 \times 5 = 2.5 \ VV_{R3}$$
...
Ba điện trở mắc song song: R1=6 
$$\Omega$$
R\_1 = 6 , R2=3  $\Omega$ R\_2 = 3, R3=2  $\Omega$ R\_3 = 2. Tổng điện trở: 1
