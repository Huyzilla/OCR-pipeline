...
Giả sử *y* = *f* (*x*1*, x*2) với *x*1*, x*2*, y* ∈ N là một hàm toán học của một chương trình. Khi đó thông thường *x*<sup>1</sup> và *x*<sup>2</sup> có miền xác định thể hiện bằng các biên. Ví dụ:
...
Kiểm thử giá trị biên mạnh là mở rộng của kiểm thử giá trị biên bằng việc bổ sung các giá trị cận biên bên ngoài miền xác định. Ngoài 5 giá trị biên đã nêu ở phần trước chúng ta lấy thêm các giá trị cận biên ở ngoài miền xác định là *max*+ và *min*− như trong Hình 5.4. Các ca kiểm
...
Có thể thấy cách tổ hợp các biên và cận biên này sẽ kiểm tra kỹ hơn kiểm thử giá trị biên thông thường. Tuy nhiên số ca kiểm thử theo cách này tăng lên đáng kể, lên đến 5*<sup>n</sup>* ca kiểm thử so với 4*n* + 1 ca theo kiểm thử biên thông thường.

Tương tự như kiểm thử giá trị biên mạnh, ta có thể mở rộng kiểm thử biên tổ hợp với bộ 7 giá trị của kiểm thử giá trị biên mạnh. Chúng ta sẽ kiểm tra được kỹ hơn nhưng cũng mất nhiều công sức hơn, đến 7*<sup>n</sup>* ca kiểm thử.
