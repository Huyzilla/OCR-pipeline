...
Quá trình ký và kiểm tra chữ ký số sử dụng giải thuật RSA tương tự như quá trình ký và kiểm tra chữ ký số tổng quát đã trình bày ở mục [3.4.1.2](#page-0-1) và [Hình 3.34,](#page-0-0) trong đó quá trình ký sử dụng giải thuật mã hóa RSA với khóa riêng của người gửi và quá trình kiểm tra sử dụng giải thuật giải mã RSA với khóa công khai của người gửi.
...
Chứng chỉ số có thể được sử dụng để xác minh chủ thể thực sự của một khóa công khai. [Hình 3.35](#page-4-0) là giao diện biểu diễn một chứng chỉ số do bên thứ 3 là một đơn vị của công ty Verisign cấp cho tên miền [www.vietcombank.com.vn](http://www.vietcombank.com.vn/) của ngân hàng TMCP Ngoại thương Việt Nam.

## **2.2 Nội dung chứng chỉ số**

Như biểu diễn trên [Hình](#page-5-0) 3.36, nội dung của một chứng chỉ số gồm nhiều trường thông tin. Các trường thông tin cụ thể theo chuẩn chứng chỉ số X.509 gồm:
...
- <span id="page-4-0"></span>- Signature Algorithm: Giải thuật tạo chữ ký;
...
## <span id="page-5-0"></span>**2.3 Ứng dụng của chứng chỉ số**
...
<span id="page-7-0"></span>[Hình 3.37](#page-7-0) biểu diễn lưu đồ cấp và sử dụng chứng chỉ số trong PKI, trong đó gồm 2 khâu chính:
