...
<table><tbody><tr><th>Nút được mở<br/>rộng</th><th>Tập biên O (hàng đợi FIFO trong trường hợp này)</th></tr><tr><th></th><th>S</th></tr><tr><td>S</td><td>AS , BS , CS , ES</td></tr><tr><td>AS</td><td>BS , CS , ES, DA</td></tr><tr><td>BS</td><td>CS , ES, DA, FB</td></tr><tr><td>CS</td><td>ES , DA, FB , HC</td></tr><tr><td>ES</td><td>DA , FB, HC, GE</td></tr><tr><td>DA</td><td>FB, HC, GE</td></tr><tr><td>FB</td><td>HC , GE</td></tr><tr><td>HC</td><td>GE</td></tr><tr><td>GE</td><td>Đích</td></tr></tbody></table>
...
- Độ phức tạp tính toán: với mức độ rẽ nhánh là b và độ sâu lời giải d, thuật toán sinh ra O (bd +1) nút trước khi tìm ra lời giải hay O(bd) nút nếu kiểm tra đích trước khi thêm nút vào tập biên. Độ phức tạp này là lớn và tăng rất nhanh
