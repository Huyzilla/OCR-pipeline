...
Nguyên lý cốt lõi của siêu vật liệu là sự cộng hưởng của đơn vị cấu trúc. Với siêu vật liệu điện từ, các split-ring resonator (SRR) và mảng dây kim loại (wire arrays) tạo ra cộng hưởng từ và điện, dẫn đến ε<sub>eff</sub> hoặc μ<sub>eff</sub> âm trong vùng tần số hẹp.
...
- Công thức hiệu dụng:  $\epsilon_{eff} = f(\chi_e)$ ,  $\mu_{eff} = f(\chi_m)$ , trong đó  $\chi$  là độ từ cảm và điện cảm.
...
23.54.27\_Al Race 4. Chế tạo siêu vật liệu đòi hỏi công nghệ vi chế tạo chính xác để tạo ra cấu trúc lặp lại tuần hoàn với kích thước từ micro đến nano. Các phương pháp chính gồm:
...
- 3. Tự tổ chức (self-assembly) và in phun nano: sử dụng vật liệu block copolymers hoặc colloidal nanoparticles để tạo màng mỏng siêu vật liệu trên diên rông với chi phí thấp.

<table><tbody><tr><th>Phương pháp</th><th>Kích thước<br/>cấu trúc</th><th>Ưu điểm</th><th>Nhược điểm</th></tr><tr><td>Photolithography</td><td></td><td>Độ chính xác cao, khả<br/>năng tích hợp</td><td>Chi phí cao, diện<br/>tích nhỏ</td></tr><tr><td>Two-photon polymerization</td><td>100 nm–1 μm</td><td>Khả năng 3D phức tạp</td><td>Tốc độ chậm, đắt<br/>đỏ</td></tr><tr><td>Self-assembly</td><td>10 nm–1 μm</td><td>Quy mô lớn, chi phí<br/>thấp</td><td>Độ đồng nhất hạn<br/>chế</td></tr></tbody></table>

#### Siêu vật liệu điện từ **5.**
