...
**Trí Tuệ Nhân Tạo Tạo Sinh (Generative AI) Trong Thiết Kế Thuốc Và Phát Hiện Dược Phẩm Mới**
...
Các giải pháp trí tuệ nhân tạo tạo sinh sử dụng các hệ thống trí tuệ nhân tạo được gọi là [các mô hình ngôn ng](https://www.intel.vn/content/www/vn/vi/learn/large-language-models.html)ữ lớn (LLM), sử dụng mạng thần kinh sâu để xử lý và tạo văn bản. Chúng được đào tạo trên lượng dữ liệu khổng lồ, tìm ra sự tương đồng giữa các loại dữ liệu và thông tin để tạo ra và cung cấp các kết quả đầu ra mới, mạch lạc.
...
- **Bộ tự mã hóa biến thể (VAE):** VAE kết hợp các nguyên tắc từ mạng nơron và mô hình xác suất để tạo ra các phiên bản dữ liệu mới thông qua quy trình mã hóa và giải mã. Mô hình VAE bắt đầu bằng cách nén dữ liệu đầu vào thành một đại diện đơn giản hóa các đặc điểm của nó. Sau đó, nó giải mã phiên bản đơn giản hóa đó, cố gắng tái cấu trúc dữ liệu đầu vào về dạng ban đầu. Thông qua quy trình này, VAE học được các tính năng và
...
thông số cơ bản của dữ liệu, giúp nó tạo ra các kết quả đầu ra thực tế và có thể tùy chỉnh nhiều hơn.
