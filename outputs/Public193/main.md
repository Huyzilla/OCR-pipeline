...
### **1.2 Devops Engineer là vị trí gì?**
...
- Communication và Collaboration: Collaboration và communication là các nhân tố bí ẩn giúp doanh nghiệp phát triển và đánh giá DevOps. Nó đẩy nhanh quá trình phát triển, vận hành và cả các

2

team khác như marketing, sales, cho phép các bộ phận của tổ chức tiến gần hơn với việc đạt được mục tiêu.

![](images/image2.jpg)

## **1.4 Tại sao Doanh nghiệp cần Devops**
...
## **2. Lộ trình phát triển nghề Devops**

## **2.1 Devops cần học gì?**
...
- Biết cài đặt và sử dụng vài Web Server phổ biến như: Apache và Nginx. Tìm hiểu một số khái niệm và chức năng thường được sử dụng: Caching Server, Load balancer, Reverse Proxy, and Firewall. Có thể bắt đầu với một vài practice với Docker đơn giản như:
  - o Setup thử một vài cache server
  - o Giả lập có nhiều servers dưới local bằng cách dùng các Docker container. Sử dụng chức năng Load balancer của Web server để cân bằng tải cho server.
...
- Biết dùng 1 số tool để truyển khai CI&CD như jenkins, jira , git (Gitlab, Bitbucket…)… Một DevOps Engineer nên biết Infrastructure as code):
  ...
  - o Các công cụ quản lý cấu hình: Ansible, Pupet, Chef,..
