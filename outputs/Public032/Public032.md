|  | VIETTEL AI RACE | TD032           |
|--|-----------------|-----------------|
|  | DÒNG ĐIỆN       | Lần ban hành: 1 |
...
$$P=4.2\times8.4=35.3 \text{ WP} = 4.2 \text{ \times } 8.4=35.3 \text{ \times}$$
...
$$V(t) = 170\sin(2\pi \cdot 60 \cdot t)V(t) = 170 \setminus \sin(2\pi \cdot 60 \cdot t)$$
...
$$VRMS=Vp2V\_\text{text}\{RMS\} = \text{frac}\{V\_p\}\{\text{sqrt}\{2\}\}$$
...
Nguồn Pin, ắc quy, máy phát DC Máy phát AC, lưới điện Truyền tải Khó trên khoảng cách dài Dễ dàng qua máy biến áp
