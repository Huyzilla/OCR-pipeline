...
\DeclareRobustCommand{\plaincode}[1]{%
    \begingroup
    \urlstyle{same}%
...
\AtBeginBibliography{\urlstyle{same}}
...
% Đánh số các công thức display viết bằng \[...\].
...
\chapter{TỔNG QUAN VÀ CÔNG TRÌNH LIÊN QUAN}
...
\subfile{Chuong/3_Mo_hinh_de_xuat}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{ĐÁNH GIÁ THỰC NGHIỆM}
\label{chapter:Experiment}
\subfile{Chuong/4_Danh_gia_thuc_nghiem}
...
% Phần hướng dẫn mẫu của template, không đưa vào bản final.
% \newpage
...
\titlecontents{chapter}
    ...
    {{\bfseries{\scshape} PHỤ LỤC \thecontentslabel.\ }}
    {}
    {\titlerule*[0.3pc]{.}\contentspage}

\input{Chuong/Phu_luc_A}

\newpage
\input{Chuong/Phu_luc_B}

\newpage
\input{Chuong/Phu_luc_C}
\end{document}
