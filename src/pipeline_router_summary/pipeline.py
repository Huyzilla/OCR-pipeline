...
# -*- coding: utf-8 -*-
"""
Main Pipeline Orchestration: Router → DocIndex Search → Multi-Doc Retrieve → Answer
"""
...
class RouterSummaryQAPipeline:
    """
    Full pipeline:
      1. Router (GPT-4o-mini)  — intent classify + public_id regex
      2. DocIndexer            — BM25 + TextRank embedding + RRF → top-2 docs
      3. MultiDocRetriever     — hybrid chunk retrieve + BGE rerank → top-5
      4. AnswerGenerator       — GPT-4o-mini (CoT cho tinh_toan, direct cho tra_cuu)
    """
