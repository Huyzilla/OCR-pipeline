...
OUTPUT_CSV = Path("question_v2_onnx_int8.csv")
OUTPUT_JSON = Path("question_v2_onnx_int8.json")

QUERY_CACHE = CACHE_DIR / "cache_query_question_v2.pkl"
PREPARED_CACHE = CACHE_DIR / "cache_prepared_question_v2.pkl"
CHUNK_EMB_CACHE = CACHE_DIR / "cache_chunk_embeddings_v2.pkl"
CHROMA_PATH = Path("chroma_db_viettel_v2")
CHROMA_COLLECTION = "rag"

EMBEDDING_MODEL = str(MODELS_DIR / "baseline_seed42")
EMBEDDING_TRUNCATE_DIM = 512
RERANK_MODEL = str(MODELS_DIR / "reranker_onnx_int8")
